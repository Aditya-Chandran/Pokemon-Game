...
public class Pokemon {
    ...
    public static void addPokemons(){
        ...
        /*50*/Pokemon arceus=new Pokemon("Arceus",15,120, , ,"./pokemonSprites/arceus.png");
        pokList.add(arceus);

        /*51*/Pokemon darkrai=new Pokemon("Darkrai",15,125, , ,"./pokemonSprites/darkrai.png");
        pokList.add(darkrai);

        /*52*/Pokemon deoxys=new Pokemon("Deoxys",15,150, , ,"./pokemonSprites/deoxys.png");
        pokList.add(deoxys);

        /*53*/Pokemon dialga=new Pokemon("Dialga",15,90, , ,"./pokemonSprites/dialga.png");
        pokList.add(dialga);
        
        /*54*/Pokemon giratina=new Pokemon("Giratina",15,90, , ,"./pokemonSprites/giratina.png");
        pokList.add(giratina);
        
        /*55*/Pokemon groudon=new Pokemon("Groudon",15,90, , ,"./pokemonSprites/groudon.png");
        pokList.add(groudon);
        
        /*56*/Pokemon hoopa=new Pokemon("Hoopa",15,70, , ,"./pokemonSprites/hoopa.png");
        pokList.add(hoopa);
        
        /*57*/Pokemon kyogre=new Pokemon("Kyogre",15,90, , ,"./pokemonSprites/kyogre.png");
        pokList.add(kyogre);
        
        /*58*/Pokemon kyurem=new Pokemon("Kyurem",15,95, , ,"./pokemonSprites/kyurem.png");
        pokList.add(kyurem);

        /*59*/Pokemon latios=new Pokemon("Latios",15,110, , ,"./pokemonSprites/latios.png");
        pokList.add(latios);
        
        /*60*/Pokemon lugia=new Pokemon("Lugia",15,110, , ,"./pokemonSprites/lugia.png");
        pokList.add(lugia);
        
        /*61*/Pokemon mewtwo=new Pokemon("Mewtwo",15,130, , ,"./pokemonSprites/mewtwo.png");
        pokList.add(mewtwo);
        
        /*62*/Pokemon palkia=new Pokemon("Palkia",15,100, , ,"./pokemonSprites/palkia.png");
        pokList.add(palkia);

        /*63*/Pokemon rayquaza=new Pokemon("Rayquaza",15,95, , ,"./pokemonSprites/rayquaza.png");
        pokList.add(rayquaza);
        
        /*64*/Pokemon reshiram=new Pokemon("Reshiram",15,90, , ,"./pokemonSprites/reshiram.png");
        pokList.add(reshiram);
        
        /*65*/Pokemon xerneas=new Pokemon("Xerneas",15,99, , ,"./pokemonSprites/xerneas.png");
        pokList.add(xerneas);
        
        /*66*/Pokemon yveltal=new Pokemon("Yveltal",15,99, , ,"./pokemonSprites/yveltal.png");
        pokList.add(yveltal);
        
        /*67*/Pokemon zekrom=new Pokemon("Zekrom",15,90, , ,"./pokemonSprites/zekrom.png");
        pokList.add(zekrom);
        
        /*68*/Pokemon zygrade=new Pokemon("Zygrade",15,95, , ,"./pokemonSprites/zygrade.png");
        pokList.add(zygrade);
